...
def init_args():
    ...
    det_group.add_argument("--det_use_coreml", action="store_true", default=False)
    ...
    cls_group.add_argument("--cls_use_coreml", action="store_true", default=False)
    ...
    rec_group.add_argument("--rec_use_coreml", action="store_true", default=False)
    ...
    def __call__(self, config, **kwargs):
        ...
        new_config = {
            ...
            "Det": self.update_params(
                ...
                det_dict,
                "det_",
                ["det_model_path", "det_use_cuda", "det_use_dml", "det_use_coreml"],
            ),
            "Cls": self.update_params(
                config["Cls"],
                cls_dict,
                "cls_",
                ["cls_label_list", "cls_model_path", "cls_use_cuda", "cls_use_dml", "cls_use_coreml"],
            ),
            "Rec": self.update_params(
                config["Rec"],
                rec_dict,
                "rec_",
                ["rec_model_path", "rec_use_cuda", "rec_use_dml", "rec_use_coreml"],
            ),
        }
